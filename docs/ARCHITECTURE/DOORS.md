...
`apps/web` is the earlier face over the same API: six personas, a scripted story week, and a landing page that names what is deliberately undrawn. It is kept as a reference; ../DEMO.md (`docs/DEMO.md` in the repository) records what it shows and refuses to fake.

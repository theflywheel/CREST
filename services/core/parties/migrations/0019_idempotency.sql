-- Durable request fingerprints for mutation replay. The ledger stores no
-- request or response body: handlers reconstruct a private response from the
-- resource reference after a completed replay.
